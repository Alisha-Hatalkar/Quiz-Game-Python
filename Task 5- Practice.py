...
question = {
	"How many days are in a week?": ['2', '3', '7', '9'],
	"How many months are there in a year?": ['12', '1', '5'],
	"What is symbol for Potassium as per the periodic table?": ['S', 'K', 'Ca', 'O']
}
...
if __name__ == "__main__":
	...
	Label(root, text="QUIZ APPLICATION",
		font="calibre 40 bold",
		relief=SUNKEN, background="LawnGreen",
		padx=10, pady=9).pack()
